...
class Connection
{
    ...
    protected function openSock($repeat = false)
    {
        ...
        $ctx = ['ssl' => ['ciphers' => 'ECDHE+AESGCM:ECDHE+CHACHA20:DHE+AESGCM:DHE+CHACHA20:ECDH+AES:DH+AES:RSA+AESGCM:RSA+AES:!aNULL:!eNULL:!MD5:!DSS','verify_peer' => false, 'verify_peer_name' => false, 'SNI_enabled' => true]];
